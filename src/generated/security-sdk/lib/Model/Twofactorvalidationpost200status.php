<?php
/**
 * Twofactorvalidationpost200status
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * Twofactorvalidationpost200status Class Doc Comment
 *
 * @category Class
 * @package  Naranja\Security
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Twofactorvalidationpost200status implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'twofactorvalidationpost200status';
     ...
     *
     * @param float|null $expiration_time expiration_time
     *
     * @return $this
     */
